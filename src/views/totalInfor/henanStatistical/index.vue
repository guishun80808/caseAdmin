 ...
 * @LastEditTime: 2019-09-05 09:51:51
...
export default {
  ...
  data() {
    return {
      ...
      iframeSrc: "model/HN_court/page.html"
    };
  },
  methods: {
    handleSearch() {
      if (
        ...
        this.paramsData.courtRoomId == "" &&
        this.paramsData.cbrId == ""
      ) {
        this.iframeSrc =
          "model/HN_court/page.html?courtId=" + this.paramsData.courtId;
        // window.open(
        //   "model/HN_court/page.html?courtId=" + this.paramsData.courtId
        // );
      } else if (
        ...
        this.iframeSrc =
          "model/HN_court/page.html?courtId=" +
          this.paramsData.courtId +
          "&courtRoomId=" +
          this.paramsData.courtRoomId;
        // window.open(
