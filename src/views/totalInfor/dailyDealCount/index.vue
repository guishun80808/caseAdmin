...
import { getQueryDealCount } from "@/api/totalInfor/dailyDealCount";
...
export default {
  ...
  created() {},
  mounted() {
    this.getQueryDealCount(this.paramsData);
    
  },
  watch: {},
  methods: {
    getQueryDealCount(params) {
      getQueryDealCount(this.paramsData)
        .then(response => {
