 ...
 * @LastEditTime: 2019-10-23 17:27:09
 * @LastEditors: GuiShun
 -->
<template>
  <div id="childcase-page">
    ...
    <div class="content">
      ...
      >
        ...
        <el-table-column prop="court_name" label="法院名称" width="200"></el-table-column>
        ...
        <el-table-column label="推送状态" width="200">
...
import {
  ...
  repush,
  caseModel
} from "@/api/caseManage/childCasePush";
