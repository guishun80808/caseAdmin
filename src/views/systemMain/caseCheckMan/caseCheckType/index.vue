 ...
 * @LastEditTime: 2019-10-18 16:52:46
 * @LastEditors: GuiShun
 -->
<template>
  <div>
      ...
      >
        ...
        <el-table-column fixed="right" label="操作" width="100">
          <template slot-scope="scope">
            <el-button @click="editSaveOpen(scope.row)" type="text" size="small" v-auth="['caseCheck:update']">编辑</el-button>
            <el-button @click="delServer(scope.row)" type="text" style="color: red;" size="small" v-auth="['caseCheck:delete']">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    async addSaveServer() {
      try {
        await addCaseCheckFs(this.addParams);
        this.$message({
           showClose: true,
          message: "新增成功",
          type: "success"
    ...
    async editSaveServer() {
      try {
        await editCaseCheckFs(this.addParams);
        this.$message({
           showClose: true,
          message: "编辑成功!",
          type: "success"
